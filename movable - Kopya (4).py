...
from PyQt5.QtWidgets import QApplication, QMainWindow, QWidget, QLabel, QComboBox, QMessageBox, QFrame, QPushButton, QSlider # Import QSlider
...
class ToolWindow(QWidget):
    ...
    def __init__(self, parent_paint_window):
        ...
        # Connect to a unified method that delegates and handles button text update in PaintCanvasWindow
        ...
        self.brushSizeSlider = self.findChild(QSlider, "horizontalSlider") # Find the QSlider
        if self.brushSizeSlider:
            ...
            self.brushSizeSlider.setOrientation(Qt.Horizontal) # Ensure it's horizontal
            self.brushSizeSlider.setTickPosition(QSlider.TicksBelow) # Optional: show ticks
            self.brushSizeSlider.setTickInterval(5) # Optional: tick interval
